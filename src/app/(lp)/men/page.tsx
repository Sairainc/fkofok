            ...
            <div className="mt-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                <div className="bg-white rounded-2xl p-8 shadow-sm">
                  {React.createElement(PieChart, { data: _womenAgeData })}
                </div>
            ...
            <div className="mt-16">
              <div className="max-w-2xl mx-auto">
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm">
                  {React.createElement(BarChart, { data: menAgeData })}
                </div>
              ...
              <div className="max-w-4xl mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
                    <div className="flex flex-col items-center text-center">
                      <div className="w-16 h-16 rounded-full bg-[rgba(255,108,180,0.1)] flex items-center justify-center mb-6">
                        {React.createElement(CalendarIcon, { className: "w-8 h-8 text-[rgba(255,108,180,0.8)]" })}
                      </div>
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
                    <div className="flex flex-col items-center text-center">
                      <div className="w-16 h-16 rounded-full bg-[rgba(255,108,180,0.1)] flex items-center justify-center mb-6">
                        {React.createElement(BriefcaseIcon, { className: "w-8 h-8 text-[rgba(255,108,180,0.8)]" })}
                      </div>
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
                    <div className="flex flex-col items-center text-center">
                      <div className="w-16 h-16 rounded-full bg-[rgba(255,108,180,0.1)] flex items-center justify-center mb-6">
                        {React.createElement(UserIcon, { className: "w-8 h-8 text-[rgba(255,108,180,0.8)]" })}
                      </div>
